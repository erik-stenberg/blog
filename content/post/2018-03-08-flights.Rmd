---
title: "Airline routes Shiny App"
author: "Erik"
date: '2018-03-08'
slug: flights
tags: []
...
server <- function(input, output) {
  ...
  # Create the list of different airlines to choose from in the UI
  output$airSelector <- renderUI({
    selectizeInput(inputId = "selectAirline", label = "Select maximum three airline companies IATA code",multiple = T, options = list(maxItems = 3), choices=rev(unique(flights$airline))) 
  })
