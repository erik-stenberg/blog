...
Then, I create a new variable i) `Delay` is 1 if the plane was delayed, ii) `Car` is 1 if the flights is flewn by one of the four selected carreirs, iii) `Night` that is 1 if the the departure was after 6 pm or earlier than 6am and iv) `Weekend`if the departure was on a Sunday. 
```{r}
